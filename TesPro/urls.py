...
from TesPro.views import bienvenida,bienvenidaRojo,categoriaEdad,horaActual,contenidoHTML, miPrimeraPlantilla

from TesPro.views import PlantillaParametro
