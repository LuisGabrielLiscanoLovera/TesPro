...
class CreateTalla(View):
    def  get(self, request):
        ...
        ifNtallaExist=Talla.objects.filter(nom_talla__icontains=        nomTalla           = request.GET.get('nomTalla', None).upper()
, first_name__icontains="Bar")
        print(ifNtallaExist,3333333333)
