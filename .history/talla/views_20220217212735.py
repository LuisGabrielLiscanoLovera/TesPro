...
class CreateTalla(View):
    def  get(self, request):
        ...
        criterion1 = Q(question__contains=nomTalla)
        criterion2 = Q(question__contains=2)
        q = T.objects.filter(criterion1 & criterion2)

        ifNtallaExist      = Talla.objects.filter(nom_talla__contains=nomTalla)
        
        print(nomTalla, ifNtallaExist,3333333333)
