    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('btnInfo', models.CharField(blank=True, default='<button type="button" class="btn btn-outline-light text-center btn-sm btn-block">Info</button>', max_length=30, null=True)),
                ('btnAcci', models.CharField(blank=True, default='<button type="button" class="btn btn-outline-light text-center btn-sm btn-block ">Accion</button>', max_length=30, null=True)),
