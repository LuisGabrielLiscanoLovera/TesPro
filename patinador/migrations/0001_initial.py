    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('btnAcci', models.CharField(blank=True, default='<button type="button" class="btn btn-outline-info text-center btn-sm btn-block ">Accion</button>', max_length=97, null=True)),
