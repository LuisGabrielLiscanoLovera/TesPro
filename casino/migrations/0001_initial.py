    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('btnAcci', models.CharField(blank=True, default='\n    <form id="importeCasino" >\n\t\t\t\t\t\t\t<input type="number" hidde="True" name="idEmpresa" value="{{ i.id }}">\n\t\t\t\t\t\t\t<button class="btn btn-underline  icofont-dollar-true text-white" type="submit"></button>\n\t\t\t\t\t\t\t   \n\t\t\t\t\t\t</form>\n    \n    ', max_length=1000, null=True)),
