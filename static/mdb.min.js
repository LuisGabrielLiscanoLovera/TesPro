            ...
            return function t(e, n, r) {
                ...
                59: [function(t, e, n) {
                    ...
                    e.exports = function() {
                        var t = a.extend({
                            initialize: function() {
                                if (!r) throw new Error("Chart.js - Moment.js could not be found! You must include it before Chart.js to use the time scale. ");
                            ...
                            function t(t) {
                                ...
                                function p() {
                                    ...
                                    if (i && r) l.emToPx = L.lastEmToPx, l.percentToPxWidth = L.lastPercentToPxWidth, l.percentToPxHeight = L.lastPercentToPxHeight;
                                        ...
                                        var u = a(o).isSVG ? n.createElementNS("", "rect") : n.createElement("div");
