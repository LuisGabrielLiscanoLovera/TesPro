    ...
    var EN = {
        ...
        formatShowingRows: function formatShowingRows(pageFrom, pageTo, totalRows, totalNotFiltered) {
            if (totalNotFiltered !== undefined && totalNotFiltered > 0 && totalNotFiltered > totalRows) {
                return " ".concat(pageFrom, " to ").concat(pageTo, " of ").concat(totalRows, " rows (filtered from ").concat(totalNotFiltered, " total rows)");
            }

            return " ".concat(pageFrom, " to ").concat(pageTo, " of ").concat(totalRows, " rows");
        },
        ...
        _createClass(BootstrapTable, [{
            ...
            value: function initPagination() {
                ...
                if (this.paginationParts.includes('pageInfo') || this.paginationParts.includes('pageInfoShort')) {
                    ...
                    html.push("<span class=\"pagination-inf\">\n      ".concat(paginationInfo, "\n      </span>"));
                }
